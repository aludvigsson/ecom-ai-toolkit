...
from meta_ads.scripts.adsets import pause as pausecmd


def _setup_mocks(stack):
    mock_cfg = stack.enter_context(patch("meta_ads.scripts.adsets.pause.load_config"))
    mock_client_class = stack.enter_context(patch("meta_ads.scripts.adsets.pause.MetaClient"))
