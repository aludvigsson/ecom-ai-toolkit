...
from meta_ads.scripts.ads import pause as pausecmd


def _setup_mocks(stack):
    mock_cfg = stack.enter_context(patch("meta_ads.scripts.ads.pause.load_config"))
    mock_client_class = stack.enter_context(patch("meta_ads.scripts.ads.pause.MetaClient"))
