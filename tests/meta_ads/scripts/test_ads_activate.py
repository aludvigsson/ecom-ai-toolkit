...
from meta_ads.scripts.ads import activate as activatecmd


def _setup_mocks(stack):
    mock_cfg = stack.enter_context(patch("meta_ads.scripts.ads.activate.load_config"))
    mock_client_class = stack.enter_context(patch("meta_ads.scripts.ads.activate.MetaClient"))
