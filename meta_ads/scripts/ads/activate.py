"""Activate an ad — POST /<ad_id> with status=ACTIVE.
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Activate an ad (--yes required).")
    ...
    if not args.yes:
        parser.error("activating an ad spends money; pass --yes to confirm")
