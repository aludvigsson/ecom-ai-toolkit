...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Delete an ad (--yes required).")
    ...
    if not args.yes:
        parser.error("deleting an ad is irreversible; pass --yes to confirm")
